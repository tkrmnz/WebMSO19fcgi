$(function () {  
	...
	function getDataFile(){
		...
		fileNm = "/fcgi-bin/tmp/mso19data"+sidRx+".csv?sid="+ sidRx;//fcgi
	...
	function MsoConnect(Cnct){
		...
		$.ajax({
		  type: 'GET',
			url: "/fcgi-bin/mso19ctl.fcgi",//fcgi
	...
	function MsoStat(){
		...
		if((goStatPrev)&&((msoRawStat==28)||(msoRawStat==27)
		 	...
		 	fileNm = "/fcgi-bin/mso19ctl.fcgi?sid="+sidCur+"&i=t";//fcgi 

		else if((goStatPrev)&&(msoRawStat==35))
			fileNm = "/fcgi-bin/mso19ctl.fcgi?sid="+sidRx+"&i=t"; //fcgi
		else fileNm = "/fcgi-bin/mso19ctl.fcgi?sid="+sidTx+"&i=t"; //fcgi
	...
	sidTx=(new Date().getTime()-startTime);
	if(i=='A'){
		outMsg = "/fcgi-bin/mso19ctl.fcgi?sid="+sidTx+
		"&TSAMP="+nsClkRate+
		"&VDIV0="+VDIV0+
		"&VDIV1="+VDIV1+
		"&VOFF0="+OffsetDbl0+
		...
		outMsg = "/fcgi-bin/mso19ctl.fcgi?sid="+sidTx+"&i="+i;
	}
